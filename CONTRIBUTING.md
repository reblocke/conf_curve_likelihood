...
1. verifies the annotated remote tag object and binds it to the event commit;
2. requires the tag target to be contained in protected `main` history before isolated
