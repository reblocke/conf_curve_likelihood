...
def validate_portfolio_links(readme: str, html: str) -> list[str]:
    ...
    if "wald-inference Core v0.4.0" not in footer_text or "privacy" not in footer_text.lower():
        raise PortfolioLinkError("deployed footer must name Core v0.4.0 and its privacy boundary")
        ...
        try:
            request = urllib.request.Request(
                ...
                headers={
                    ...
                    "User-Agent": "confcurve-portfolio-link-check/0.2.0",
                },
            )
