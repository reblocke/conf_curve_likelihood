...
| Package description | `Static GitHub Pages app and Python core for Wald confidence-curve reconstruction` | From `pyproject.toml`; distinct from the verified live GitHub description above |
